    ...
    return (
      <div className="md:bg-[#F6F6F6] bg-[#FFFFFF] px-16">
        <div className="h-fit    py-20 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-0 ">
          ...
          <div className="flex flex-col flex-nowrap md:flex-row md:flex-wrap gap-10 md:gap-0 items-center md:items-start">
            <div className="w-full text-center md:w-1/2 h-1/2 px-4 md:mb-4">
        ...
        <div className=" h-fit flex justify-center">
          <div className="bg-[#2B2730] w-full text-white text-center py-10  rounded-2xl">
            ...
            <p className="my-3 text-[15px] font-thin">
